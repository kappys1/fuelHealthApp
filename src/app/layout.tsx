...
// Display / cifras (Plus Jakarta Sans) — 05-DISENO §3 (Restyle v2).
// --font-condensed se alias a --font-display en globals.css (sin condensada dedicada).
...
// Cuerpo (Onest) — 05-DISENO §3 (Restyle v2)
const body = Onest({
  subsets: ["latin"],
